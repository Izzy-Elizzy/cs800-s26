...
Dr. Michael L. Nelson: mln at cs.odu.edu, <https://www.cs.odu.edu/~mln/>

My office hours will be zoom, Mondays and Wednesdays 12-1pm, or by appointment. See the email list for the link to the Zoom office hours meeting room. For Zoom office hours, students will be placed into the waiting room if I am already meeting with another student. If you cannot attend during regular office hours, please contact me to set up an alternate appointment time.

## Meeting Times and Course Delivery Method

Students will be expected to discuss their weekly current events topics for 2-3 minutes each.  Students will be expected to present and discuss during class other assignments and course materials as assigned throughout the semester.   
...
* Weekly sharing of current events -- 13 points total
* Dissertation presentation -- 37 points 
...
Subject to change.  See the [course README.md](https://github.com/phonedude/cs800-s26/blob/main/README.md) for details. 

[ODU Spring 2026 academic schedule](https://www.odu.edu/academics/calendar/spring)

|Week |Class Date|Topic|Due|
|---|---|---|---|
|1|	Jan 26|	Course Intro, What's Grad School All About? | 
|2|	Feb 2|	Academic Presence, Research Careers | 
|3|	Feb 9|	Reading Academic Papers |
|4|	Feb 16| Academic Publishing and Reviewing |
|5|	Feb 23| Academic Communication - Writing  |
|6|	Mar 2|	Academic Communication - Presenting |
|7|	Mar 9|	Visualization Basics, Intro to R |
|8|	Mar 16|	**NO CLASS - Spring Break** |
|9|	Mar 23|	ODU-CS Faculty Presentations |
|10| Mar 30|  ODU-CS Faculty Presentations |
|11| Apr 6|	TBA |
|12| Apr 13|	Student Dissertation Presentations |
|13| Apr 20|	Student Dissertation Presentations |
|14| Apr 27|	Student Dissertation Presentations |
|15| May 4|	Student Dissertation Presentations |
...
Please join the class email list at: https://groups.google.com/g/cs800-s26

Each student must check the class email daily. You should use our class email to ask and answer general course-related questions. I will use email to notify you about important updates (assignment deadline changes, office hours cancellations, etc.).

### Attendance

I expect you to arrive on time for class. Your grade will be affected if you are consistently tardy. Students may leave after 15 minutes if the instructor or a guest lecturer does not arrive in that time.

If you have to miss a class, you are responsible checking with me. 

If there are days on which the scheduled class meeting time is cancelled due to weather, there may still be assignments made and due. Check the class email list.
